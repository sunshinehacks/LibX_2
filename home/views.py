...
#     return render(request, "library1/viewbook.html", context)
...
#     context['form']= form
#     return render(request, "library1/addbook.html",context)
...
#         if form.is_valid():
#             form.save()
#             return render(request,'library1/bookadded.html')
#     return render(request,'library1/addbook.html',{'form':form})
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            if user.is_staff or user.is_superuser:
                return redirect('home:afterlogin')  # Redirect admin or staff to afterlogin page
            else:
                return redirect('home:userafterlogin')  # Redirect normal user to userafterlogin page
        else:
...
#def pass_reset(request):
    ...
    #         if not new_pass:
    #             error_message = 'ENTER NEW PASS'
    #         elif not new_pass2:
    #             error_message = 'ENTER CONFIRM PASS'
    #         elif new_pass == user.password:
    #             error_message = 'THIS PASS ALREADY EXIST'
    #         if not error_message:
